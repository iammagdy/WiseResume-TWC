...
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS portfolio_theme TEXT DEFAULT NULL;
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS views INTEGER DEFAULT 0;

-- Update the get_public_portfolio RPC to return all new fields plus resume.id
