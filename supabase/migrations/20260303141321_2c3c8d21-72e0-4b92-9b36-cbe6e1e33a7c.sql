...
-- Issue 1: Fix store_screenshots overly permissive RLS
DROP POLICY IF EXISTS "Service role can delete store_screenshots" ON public.store_screenshots;
DROP POLICY IF EXISTS "Service role can insert store_screenshots" ON public.store_screenshots;

CREATE POLICY "Service role can delete store_screenshots"
ON public.store_screenshots
FOR DELETE
USING (false);
...
-- Issue 2: Update get_public_portfolio to include github_projects_cache
