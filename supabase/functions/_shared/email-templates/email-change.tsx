    ...
    <Body style={main}>
      <Container style={wrapper}>
        ...
        <Section style={card}>
          ...
          <Text style={bodyText}>
            You requested to update your email from{' '}
            <span style={highlight}>{email}</span> to{' '}
            <span style={highlight}>{newEmail}</span>.
          </Text>
...
const highlight = { color: '#1a1a2e', fontWeight: '600' as const }
