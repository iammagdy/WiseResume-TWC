...
export const coverLetters = pgTable(
  ...
  (t) => ({
    userUpdatedIdx: index('idx_cover_letters_user_updated').on(t.userId, t.updatedAt.desc()),
...
export const resignationLetters = pgTable(
  ...
  (t) => ({
    userUpdatedIdx: index('idx_resignation_letters_user_updated').on(t.userId, t.updatedAt.desc()),
  }),
);
