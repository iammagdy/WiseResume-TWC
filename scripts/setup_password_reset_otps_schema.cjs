...
const ATTRIBUTES = [
  ...
  { key: 'purpose', type: 'string', size: 64, required: true, defaultVal: 'password_reset' },
  { key: 'attempts', type: 'integer', required: true, min: 0, max: 99, defaultVal: 0 },
  { key: 'max_attempts', type: 'integer', required: true, min: 1, max: 99, defaultVal: 5 },
  { key: 'expires_at', type: 'datetime', required: true },
  { key: 'used', type: 'boolean', required: true, defaultVal: false },
