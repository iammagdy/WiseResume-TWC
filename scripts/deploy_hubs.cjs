...
async function ensureBillingCheckoutVariables() {
    ...
    if (provider === 'paypal') {
        ...
        for (const [key, value] of [
            ...
            ['BILLING_SANDBOX_PRO_PRODUCT_ID', process.env.BILLING_SANDBOX_PRO_PRODUCT_ID || 'PROD-1XU04121YA801240V'],
            ['BILLING_SANDBOX_PREMIUM_PRICE_ID', process.env.BILLING_SANDBOX_PREMIUM_PRICE_ID || 'P-56D04005HN592501XNKN6I3Q'],
            ['BILLING_SANDBOX_PREMIUM_PRODUCT_ID', process.env.BILLING_SANDBOX_PREMIUM_PRODUCT_ID || 'PROD-1XU04121YA801240V'],
