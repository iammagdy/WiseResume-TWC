...
> **Authoritative source**: `src/integrations/supabase/types.ts` (auto-generated by Supabase CLI). **Always read that file directly before writing any new table-dependent code.** The inventory below was compiled from SQL migrations, edge function code analysis, and code review feedback as of 2026-04-15. It is a best-effort reference — types.ts is the ground truth.

### Core Platform Tables (confirmed in codebase analysis)
