...
export function ContactSection() {
  ...
  const handleChange = (field: string, value: string) => {
   ...
   const getEmailError = (): string | undefined => {
     const email = currentResume.contactInfo.email;
   ...
   const getPhoneError = (): string | undefined => {
     const phone = currentResume.contactInfo.phone;
   ...
   const getLinkedinError = (): string | undefined => {
     const linkedin = currentResume.contactInfo.linkedin;
     if (!linkedin) return undefined; // Optional
     try {
   ...
   const getPortfolioError = (): string | undefined => {
     const portfolio = currentResume.contactInfo.portfolio;
     if (!portfolio) return undefined; // Optional
     try {
