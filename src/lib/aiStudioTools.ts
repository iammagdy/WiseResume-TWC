...
export const aiStudioToolEntries: AiStudioToolEntry[] = [
  ...
  { id: "humanizer", icon: Shield, label: "Style Review", desc: "Review formulaic writing", color: "text-violet-500", cost: "detect-and-humanize", visibility: "hidden", parentWorkflowId: "improve-resume" },
  ...
  { id: "ab-compare", icon: GitCompareArrows, label: "A/B Compare", desc: "Compare local readiness", color: "text-rose-500", cost: "score", visibility: "hidden", parentWorkflowId: "improve-resume" },
  ...
  { id: "company-briefing", icon: Building2, label: "Company Briefing", desc: "Source-based prep", color: "text-teal-500", cost: "company-briefing", visibility: "primary", parentWorkflowId: "company-briefing" },
...
export const aiStudioWorkflows: AiStudioWorkflowEntry[] = [
  ...
  },
  {
    ...
    description: "Turn company or role context you provide into a reviewable interview-prep draft.",
    icon: Building2,
    color: "text-teal-500",
    visibility: "primary",
    primaryAction: { label: "Prepare Company Context", toolId: "company-briefing" },
    secondaryActions: [],
