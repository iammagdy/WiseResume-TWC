...
export const PORTFOLIO_THEMES: PortfolioThemeConfig[] = [
  ...
  },
  {
    ...
    category: 'corporate',
    isNew: false,
    colors: { bg: '#ffffff', fg: '#111827', card: '#f9f9f9', border: '#e5e7eb', muted: '#374151', accentDefault: '#e84545' },
  ...
  },
  {
    ...
    category: 'creative',
    isNew: true,
    colors: { bg: '#faf9f6', fg: '#1a1a2e', card: '#ffffff', border: 'rgba(0,0,0,0.06)', muted: '#4b5563', accentDefault: '#e84545' },
  ...
  },
  {
    ...
    category: 'corporate',
    isNew: true,
    colors: { bg: '#fefefe', fg: '#0f172a', card: '#ffffff', border: '#e2e8f0', muted: '#4b5563', accentDefault: '#1e3a5f' },
    typography: { headingFont: 'Georgia, "Times New Roman", serif', bodyFont: 'Inter, system-ui, sans-serif', headingWeight: 700 },
  ...
  },
  {
    ...
    category: 'freelancer',
    isNew: true,
    colors: { bg: '#ffffff', fg: '#18181b', card: '#ffffff', border: 'rgba(0,0,0,0.08)', muted: '#374151', accentDefault: '#7c3aed' },
    typography: { headingFont: 'Inter, system-ui, sans-serif', bodyFont: 'Inter, system-ui, sans-serif', headingWeight: 800 },
