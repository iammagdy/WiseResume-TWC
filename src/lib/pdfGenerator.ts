...
export class PdfGenerationError extends Error {
  code: 'EMPTY_CANVAS' | 'MISSING_ELEMENT' | 'CAPTURE_FAILED' | 'TRUNCATED_CANVAS' | 'ENTRY_TOO_TALL' | 'UNKNOWN';
...
// NOTE: The legacy public exports generatePDF, generateOnePagePDF,
// generateCoverLetterPDF, and generateCombinedPDF were removed in
// favor of the Puppeteer-based pipeline in @/lib/nativePdfGenerator
// (generateNativePDF, generateCoverLetterNativePDF, mergePDFBlobs).
// For headless exports without a live DOM template, use
// exportResumePdfFromData from @/lib/exportResumePdf.
