...
const TABLE_COLUMNS: Record<string, string[]> = {
  ...
  cover_letters: ['company', 'content', 'job_title', 'resume_title', 'template_style', 'title', 'tone'],
  ...
  interview_sessions: ['duration_seconds', 'improvements', 'interview_type', 'job_description', 'job_title', 'messages', 'overall_score', 'resume_title', 'strengths'],
  career_assessments: ['completed_milestones', 'quiz_answers', 'result', 'resume_title'],
