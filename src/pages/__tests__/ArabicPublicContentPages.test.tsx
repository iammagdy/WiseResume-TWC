...
async function renderPage(page: React.ReactNode, locale: 'en' | 'ar') {
...
describe('public guides and examples locale shells', () => {
  it('renders Arabic guide labels without presenting English content as Arabic', async () => {
    await renderPage(<GuidesPage />, 'ar');
  ...
  it('renders Arabic example labels without presenting English examples as Arabic', async () => {
    await renderPage(<ExamplesPage />, 'ar');
  ...
  it('does not expose an English guide body on an Arabic detail route', async () => {
    await renderPage(<GuidePage />, 'ar');
  ...
  it('keeps English route content in English', async () => {
    const { unmount } = await renderPage(<GuidesPage />, 'en');
    expect(screen.getByRole('heading', { name: 'Career Guides' })).toBeInTheDocument();
    unmount();
    await renderPage(<ExamplesPage />, 'en');
