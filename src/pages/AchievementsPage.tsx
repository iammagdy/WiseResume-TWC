...
const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: 'score-60', title: 'Getting There', description: 'Reach 60% resume readiness', icon: Target, check: (c) => c.maxScore >= 60, xp: 15 },
  { id: 'score-80', title: 'Readiness Builder', description: 'Reach 80% resume readiness', icon: Star, check: (c) => c.maxScore >= 80, xp: 40 },
  { id: 'score-95', title: 'Resume Complete', description: 'Reach 95% resume readiness', icon: Trophy, check: (c) => c.maxScore >= 95, xp: 100 },
