...
export default function PricingPage() {
  ...
  const faqItems = [
    ...
    { q: t('app.aiStudio.pricingPage.faq3Question', 'Can I cancel at any time?'), a: t('app.aiStudio.pricingPage.faq3Answer', 'Yes. You can cancel your subscription at any time directly from your Subscription settings. Your access will remain active until the end of your billing period with no further charges.') },
  ];
