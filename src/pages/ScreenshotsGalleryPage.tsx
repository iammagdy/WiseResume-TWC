...
const SCREENSHOTS = [
  { id: 'gal-hero', headline: 'Your AI Career Workspace', subtitle: 'Build resumes, practice interviews, and organize job applications with reviewable AI assistance.', gradient: 'linear-gradient(135deg, #0B0D17 0%, #1a1040 40%, #2d1b4e 70%, #0B0D17 100%)', Screen: MockHeroScreen },
  { id: 'gal-builder', headline: 'Build Parser-Friendly Resumes', subtitle: '13 sections, local readiness checks, and evidence-first suggestions.', gradient: 'linear-gradient(135deg, #0B0D17 0%, #0d2137 40%, #1a3a5c 70%, #0B0D17 100%)', Screen: MockDashboardScreen },
  { id: 'gal-tailor', headline: 'Review Job-Aligned Suggestions', subtitle: 'Paste a job description and review source-grounded rewrite suggestions.', gradient: 'linear-gradient(135deg, #0B0D17 0%, #1b0d3a 40%, #3b1d6e 70%, #0B0D17 100%)', Screen: MockAIStudioScreen },
  { id: 'gal-interview', headline: 'Practice With AI Voice Coach', subtitle: 'Spoken mock interviews with answer-by-answer feedback.', gradient: 'linear-gradient(135deg, #0B0D17 0%, #0d2a1f 40%, #1a5c40 70%, #0B0D17 100%)', Screen: MockInterviewScreen },
  { id: 'gal-recruiter', headline: 'Explore Recruiter Review Lenses', subtitle: '4 simulated review perspectives help you inspect your resume.', gradient: 'linear-gradient(135deg, #0B0D17 0%, #2a1a0d 40%, #5c3a1a 70%, #0B0D17 100%)', Screen: MockRecruiterScreen },
  { id: 'gal-templates', headline: '30 Professional Templates', subtitle: 'Modern, classic, and creative layouts with parser-focused export options.', gradient: 'linear-gradient(135deg, #0B0D17 0%, #1a0d2a 40%, #3d1a5c 70%, #0B0D17 100%)', Screen: MockTemplatesScreen },
