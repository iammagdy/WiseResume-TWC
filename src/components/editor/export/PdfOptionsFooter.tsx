...
export function PdfOptionsFooter({
  visible,
  showPageNumberControl = true,
  showPageNumbers,
  showBranding,
  isPremium,
  onPageNumbersChange,
  onBrandingChange,
}: PdfOptionsFooterProps) {
  ...
  return (
    <div className="space-y-2 shrink-0">
      ...
      {showPageNumberControl && (
        <div className="flex items-center justify-between gap-4 px-4 py-3 rounded-xl bg-muted/50 border border-border/50">
          <div>
            <Label htmlFor="page-numbers" className="font-medium text-sm">Page Numbers</Label>
            <p className="text-xs text-muted-foreground">Use your saved simple or full footer format</p>
          </div>
