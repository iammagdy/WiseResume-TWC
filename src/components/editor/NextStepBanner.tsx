...
export const NextStepBanner = memo(function NextStepBanner({ variant, onAction }: NextStepBannerProps) {
  ...
  return (
    <div
      className="mx-4 items-center gap-2 rounded-xl bg-primary/10 border border-primary/20 px-3 py-2.5 animate-in fade-in-0 slide-in-from-top-2 duration-200 pt-[5px] pb-[5px] ml-[10px] mr-[10px] mt-[2px] mb-px flex flex-row pl-[5px] pr-[5px]">
