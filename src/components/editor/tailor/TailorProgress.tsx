  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start">
        {/* Left Column: Progress status & facts */}
        <div className="flex flex-col items-center w-full">
          ...
          {/* Rotating Fun Fact */}
          {!isComplete && (
            <div className="mb-4 lg:mb-0 p-3 rounded-lg bg-warning/10 border border-warning/20 min-h-[44px] flex items-center w-full">
              <p
                className={cn(
        ...
        {/* Right Column: Step List & Actions */}
        <div className="flex flex-col w-full lg:pl-6 lg:border-l lg:border-border/30">
          ...
          {(projectedScore || (matchingKeywords && matchingKeywords > 0)) && (
            <div className="pt-4 border-t border-primary/20 space-y-2 mb-4">
