...
function CloudPuff({
  left, bottom, width, height, opacityInner = 0.92,
}: {
  left: number; bottom: number; width: number; height: number; opacityInner?: number;
}) {
  return (
    <div
      style={{
        ...
        height: `${height}px`,
        borderRadius: '50%',
        background: `radial-gradient(ellipse at 50% 60%, rgba(255,255,255,${opacityInner}) 0%, rgba(255,255,255,${opacityInner * 0.52}) 42%, rgba(255,255,255,0) 72%)`,
      }}
    />
  );
}
    ...
    >
      {isDark ? (
        ...
        <>
          ...
          {/* Atmospheric gradient — deep zenith to warm horizon */}
          <div
            className="absolute inset-0"
            style={{
          ...
          {/* Sun corona — top right, wide and soft */}
          <div
            className="absolute inset-0"
            style={{
              background: `
          ...
          {/* Aerial perspective — subtle brightening at horizon */}
          <div
            className="absolute inset-0"
            style={{
