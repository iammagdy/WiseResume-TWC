          ...
          <div className="space-y-4 mt-4 overflow-y-auto">
            ...
            {isAI && (
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-primary/5 border border-primary/10">
                <img src={wiseAiLogo} alt="WiseResume AI" loading="lazy" className="w-3.5 h-3.5 object-contain" />
                <span className="text-[10px] text-muted-foreground">Powered by <span className="text-primary font-medium">WiseResume AI</span></span>
              </div>
            )}
