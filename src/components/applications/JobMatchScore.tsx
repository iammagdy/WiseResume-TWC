  ...
  return (
    <>
      <button
        ...
        aria-label={`${score.overall}% Estimated match`}
      >
        <span className="text-[9px] absolute -top-0.5 left-0">~</span>
        {score.overall}
      </button>
      ...
      <Sheet open={showDetail} onOpenChange={setShowDetail}>
        <SheetContent side="bottom" className="h-[70dvh] rounded-t-3xl">
          <SheetHeader>
            <SheetTitle>Estimated match: ~{score.overall}%</SheetTitle>
          ...
          <div className="space-y-4 mt-4 overflow-y-auto">
            <div className="flex items-start gap-2 p-2.5 rounded-lg bg-muted text-xs text-muted-foreground">
              ...
              <span>
                Local match estimate based on keyword overlap and experience. No AI analysis or credits are used.
              </span>
            </div>
            {/* Score bars */}
