    ...
    <div className="p-8 font-sans text-sm leading-relaxed">
      ...
      {resume.summary && (
        <section data-section="summary" className="mb-6">
          <h2 className="text-lg font-bold text-emerald-600 mb-2">🚀 About</h2>
          <p className="text-gray-700">{resume.summary}</p>
        </section>
      )}
      {resume.experience.length > 0 && (
        <section data-section="experience" className="mb-6">
          <h2 className="text-lg font-bold text-emerald-600 mb-3">💼 Experience</h2>
      ...
      {resume.skills.length > 0 && (
        <section data-section="skills">
          <h2 className="text-lg font-bold text-emerald-600 mb-2">⚡ Stack</h2>
