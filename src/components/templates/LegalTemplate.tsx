    ...
    <div className="p-8 font-serif text-sm leading-relaxed">
      ...
      {resume.summary && (
        <section data-section="summary" className="mb-5">
          ...
          <p data-break-child className="text-gray-700 text-justify">{resume.summary}</p>
        </section>
      )}
          ...
          <div className="space-y-4">
            {resume.experience.map(exp => {
              ...
              <div key={exp.id} data-break-avoid>
                ...
                <p className="text-gray-600 text-xs italic">{exp.company}{exp.account && ` · ${exp.account}`}{range && `, ${range}`}</p>
