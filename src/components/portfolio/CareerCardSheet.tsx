            ...
            >
              <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: `1px solid ${s.divider}`, paddingTop: '20px', marginTop: '16px' }}>
                  <a href={getAppUrl()} target="_blank" rel="noreferrer" style={{ fontSize: '13px', color: s.textMuted, fontWeight: 500, textDecoration: 'none' }}>Made with <span style={{ color: accentColor, fontWeight: 700 }}>WiseResume</span></a>
