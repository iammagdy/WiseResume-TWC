...
export function KpiCard({ label, value, sub, icon: Icon, accent = 'primary', current, previous, trend, hideDelta }: Props) {
  const a = ACCENT_MAP[accent];
  return (
    <div className={cn(
      'relative overflow-hidden rounded-xl border border-border bg-gradient-to-br p-4 shadow-sm',
      a.bg,
    )}>
      <div className="flex items-start justify-between gap-2">
        ...
        {!hideDelta && current !== undefined && previous !== undefined && (
