 ...
 type ParseState = 'idle' | 'parsing' | 'preview' | 'importing' | 'done';
 ...
 export function LinkedInImportSheet({ 
  ...
  const linkedinUrl = linkedinUsername 
   ...
   const handleImport = () => {
     ...
     // Build partial data based on selections
     const importData: Partial<LinkedInData> = {};
     if (selectedSections.summary && parsedData.summary) {
       importData.summary = parsedData.summary;
     }
     if (selectedSections.experience && parsedData.experience?.length) {
       importData.experience = parsedData.experience;
     }
     if (selectedSections.education && parsedData.education?.length) {
       importData.education = parsedData.education;
     }
     if (selectedSections.skills && parsedData.skills?.length) {
       importData.skills = parsedData.skills;
     }
               ...
               >
                 ...
                 {parsedData.summary && (
                   <motion.div
                     ...
                     className={`p-4 rounded-xl border transition-colors ${
                       selectedSections.summary ? 'border-primary bg-primary/5' : 'border-border'
                     }`}
                   >
                 ...
                 {parsedData.experience?.length > 0 && (
                   <motion.div
                     ...
                     className={`p-4 rounded-xl border transition-colors ${
                       selectedSections.experience ? 'border-primary bg-primary/5' : 'border-border'
                     }`}
                   >
                     <div className="flex items-start gap-3">
                       <Checkbox 
                       ...
                       <div className="flex-1 min-w-0">
                         ...
                         <div className="space-y-1">
                           ...
                           {parsedData.experience.length > 3 && (
                             <p className="text-xs text-muted-foreground">
                               +{parsedData.experience.length - 3} more
                             </p>
                           )}
                         </div>
                       </div>
                 ...
                 {parsedData.education?.length > 0 && (
                   <motion.div
                     ...
                     className={`p-4 rounded-xl border transition-colors ${
                       selectedSections.education ? 'border-primary bg-primary/5' : 'border-border'
                     }`}
                   >
                     <div className="flex items-start gap-3">
                       <Checkbox 
                 ...
                 {parsedData.skills?.length > 0 && (
                   <motion.div
                     ...
                     className={`p-4 rounded-xl border transition-colors ${
                       selectedSections.skills ? 'border-primary bg-primary/5' : 'border-border'
                     }`}
                   >
                     <div className="flex items-start gap-3">
                       <Checkbox 
               ...
               >
                 ...
                 <div className="text-center">
                   ...
                   <p className="text-sm text-muted-foreground">
                     {parseState === 'done' && 'Your LinkedIn data has been added'}
                   </p>
                 </div>
               </motion.div>
             )}
