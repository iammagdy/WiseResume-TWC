...
export function SignInPromptDialog({
  ...
  description = 'Sign in to unlock the full power of WiseResume.',
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[90vw] sm:max-w-sm">
        ...
        <div className="flex flex-col gap-2.5 mt-2">
          <Button onClick={handleEmail} className="w-full gap-2">
        ...
        <button
          ...
          className="text-xs text-muted-foreground hover:text-foreground transition-colors mt-1 mx-auto"
        >
          Continue as guest
        </button>
      </DialogContent>
