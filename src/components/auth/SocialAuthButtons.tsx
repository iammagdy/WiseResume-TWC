...
export function SocialAuthButtons({ onGoogle, onApple, disabled, socialLoading }: SocialAuthButtonsProps) {
  return (
    <>
      ...
      <div className="space-y-3">
        ...
        >
          {socialLoading === 'google' ? <MiniSpinner size={20} /> : (
        ...
        >
          {socialLoading === 'apple' ? <MiniSpinner size={20} /> : (
