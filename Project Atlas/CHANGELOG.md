...
## 2026-08-22 - WiseResume PR #199 localization and mobile Subscription badge follow-up (Preview QA blocked)
...
- **Browser evidence:** Arabic Pricing passed with Free/Pro/Ultimate localized names and `$0/$5/$10`; Arabic Ultimate Subscription passed with the corrected localized chrome title and readable Coming Soon badge; Arabic Ultimate Analytics access passed with visible export control; Free English and Arabic Tailoring Hub/Analytics upgrade walls passed. Pro checks are blocked by a Preview environment/session issue: direct authenticated routes timed out and then redirected to Vercel Login after the owner switched fixtures. No product conclusion is inferred for missing Pro checks.
- **CI/release boundary:** TestSprite Pre-Check remains the known non-applicable `No tests detected` warning; no CI change was made. The previously authorized single Appwrite Preview Web-platform entry was not changed. Commit `5d2edf0cb872ae01dae644621a0302011e4342e6` is pushed on `feat/ultimate-plan-display-rename`; PR #199 remains Draft/Open and unmerged. No Production deployment occurred.
