...
- **Next action:** Keep PR #223 Draft and do not mark Ready or merge. Review the no-key idempotency correction after CI/Vercel reruns. A later explicit authorization is required before applying the schema, deploying `billing-checkout`, enabling billing, or configuring Production.
