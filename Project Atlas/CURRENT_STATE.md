...
* **P1 Pre-Load-Test Stabilization (PR #264):** `P1_DEPLOYED_VERIFIED_READY` — Merged at commit `eb11a5e0236b90c1b3cd83e9c207b4e4e1e321ec`. Production deployment verified. P1-1 (Public contact form) routed to `email-service` (`execute: ["any"]`) with Turnstile & durable `email_rate_limits` checks. P1-2 (Custom domain scan) fail-closed with 501 `custom_domains_not_supported`.
