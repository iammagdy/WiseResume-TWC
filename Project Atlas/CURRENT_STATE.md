...
**Status:** `WHATS_NEW_REVAMP_DEPLOYED_PRODUCTION_VERIFIED` (Audit Baseline: `FULL_FUNCTIONALITY_AUDIT_P1_CLOSEOUT_COMPLETE`, Billing: `BILLING_CHECKOUT_DISABLED`) — Redesigned customer-facing `/whats-new` and `/ar/whats-new` experiences merged to `main` via PR #280 (`59d38309dbd2bb68ee14cf913cf3d9192eb2b013`) and deployed via Vercel Production deployment `Hc26exYbknDjyKee7TZH3qDbRsJw` (`READY`). Shipped history reconciled through 2026-09-03 (40 verified releases):
