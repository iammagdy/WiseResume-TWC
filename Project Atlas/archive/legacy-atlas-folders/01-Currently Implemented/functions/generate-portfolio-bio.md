# generate-portfolio-bio
  ...
  **What it does:** Generates a bio paragraph for the public portfolio. (Description derived from the function name and `supabase/functions/EDGE_FUNCTION_AUDIT.md`; for full behaviour read `supabase/functions/generate-portfolio-bio/index.ts`.)
