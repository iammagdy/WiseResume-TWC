...
| `edge-shared-helpers.md` | `supabase/functions/_shared/` — 36 helper modules used by every function. |
| `cloudflare-pages-middleware.md` | `functions/_middleware.ts` — production Cloudflare Pages content-negotiation middleware. |

> Function business logic lives under `01-Currently Implemented/functions/` (one card per fn).
