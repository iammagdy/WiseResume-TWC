...
- `specs/001-wisehire-hr-platform/spec.md`
  ...
  **What it is:** WiseHire 5-step company-focused onboarding (company name, size, role types, monthly volume, first role).

  **Route(s):**
  - `  /wisehire/onboarding`

  **Where it lives:** `src/pages/wisehire/WiseHireOnboardingPage.tsx`
