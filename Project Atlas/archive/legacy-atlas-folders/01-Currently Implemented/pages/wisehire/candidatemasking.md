# CandidateMaskingPage

  **Last verified:** 2026-04-17
  **Type:** reference card
  **Sources:**
  - `src/pages/wisehire/CandidateMaskingPage.tsx`
...
- `specs/001-wisehire-hr-platform/spec.md`
  ...
  **What it is:** Bias Reduction Mode — redacts names, photos, schools via `wisehire-mask-cvs`.

  **Route(s):**
  - `  /wisehire/mask-cvs`

  **Where it lives:** `src/pages/wisehire/CandidateMaskingPage.tsx`
