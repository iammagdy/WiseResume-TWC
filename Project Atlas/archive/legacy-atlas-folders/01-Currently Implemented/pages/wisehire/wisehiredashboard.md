...
- `specs/001-wisehire-hr-platform/spec.md`
  ...
  **What it is:** WiseHire HR home — pipeline summary, recent briefs, quick actions.

  **Route(s):**
  - `  /wisehire/dashboard`

  **Where it lives:** `src/pages/wisehire/WiseHireDashboardPage.tsx`
