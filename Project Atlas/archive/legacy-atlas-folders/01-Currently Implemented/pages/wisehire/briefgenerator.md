# BriefGeneratorPage
  ...
  **Type:** reference card
  **Sources:**
  - `src/pages/wisehire/BriefGeneratorPage.tsx`
...
- `specs/001-wisehire-hr-platform/spec.md`
  ...
  **What it is:** AI Candidate Brief Generator — calls `wisehire-generate-brief`. Produces match score, strengths, concerns, interview questions, employment notes.

  **Route(s):**
  - `  /wisehire/briefs`

  **Where it lives:** `src/pages/wisehire/BriefGeneratorPage.tsx`
