# PipelinePage
  ...
  **Type:** reference card
  **Sources:**
  - `src/pages/wisehire/PipelinePage.tsx`
...
- `specs/001-wisehire-hr-platform/spec.md`
  ...
  **What it is:** Kanban pipeline: Shortlisted → Contacted → Interviewing → Offer Sent → Hired / Rejected.

  **Route(s):**
  - `  /wisehire/pipeline`

  **Where it lives:** `src/pages/wisehire/PipelinePage.tsx`
