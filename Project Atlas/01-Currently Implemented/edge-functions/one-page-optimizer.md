# one-page-optimizer
  ...
  **What it does:** Compresses a multi-page resume into a single-page layout. (Description derived from the function name and `supabase/functions/EDGE_FUNCTION_AUDIT.md`; for full behaviour read `supabase/functions/one-page-optimizer/index.ts`.)
