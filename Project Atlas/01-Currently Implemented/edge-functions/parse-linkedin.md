# parse-linkedin
  ...
  **What it does:** Parses a LinkedIn profile import into resume sections. (Description derived from the function name and `supabase/functions/EDGE_FUNCTION_AUDIT.md`; for full behaviour read `supabase/functions/parse-linkedin/index.ts`.)
