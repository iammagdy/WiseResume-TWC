# submit-contact-request
  ...
  **What it does:** Records an outbound contact request. (Description derived from the function name and `supabase/functions/EDGE_FUNCTION_AUDIT.md`; for full behaviour read `supabase/functions/submit-contact-request/index.ts`.)
