# send-contact-inquiry
  ...
  **What it does:** Records and routes a public contact inquiry. (Description derived from the function name and `supabase/functions/EDGE_FUNCTION_AUDIT.md`; for full behaviour read `supabase/functions/send-contact-inquiry/index.ts`.)
