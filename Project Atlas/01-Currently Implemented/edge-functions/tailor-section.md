# tailor-section
  ...
  **What it does:** Tailors a single resume section to a job description (sub-call of `tailor-resume`). (Description derived from the function name and `supabase/functions/EDGE_FUNCTION_AUDIT.md`; for full behaviour read `supabase/functions/tailor-section/index.ts`.)
