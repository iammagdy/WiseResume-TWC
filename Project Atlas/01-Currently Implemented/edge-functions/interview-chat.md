# interview-chat
  ...
  **What it does:** Conversational AI for the Interview Coach text mode. (Description derived from the function name and `supabase/functions/EDGE_FUNCTION_AUDIT.md`; for full behaviour read `supabase/functions/interview-chat/index.ts`.)
