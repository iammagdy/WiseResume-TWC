...
**Type:** reference card
**Sources:**
- `src/integrations/supabase/types.ts` — `Tables.store_screenshots.Row` (5 columns)
...
**What it is:** Generated app-store screenshot records.

**Schema:** 5 columns per `Tables.store_screenshots.Row` in `src/integrations/supabase/types.ts`. Columns: `created_at`, `headline`, `id`, `image_url`, `name`.
