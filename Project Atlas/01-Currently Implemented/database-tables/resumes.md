...
**Schema:** 27 columns per `Tables.resumes.Row` in `src/integrations/supabase/types.ts`. Columns: `awards`, `certifications`, `contact_info`, `created_at`, `customization`, `deleted_at`, `education`, `experience`, `hobbies`, `id`, `is_deleted`, `is_primary`, `job_match_score`, `job_url`, `parent_resume_id`, `projects`, `publications`, `references`, `skills`, `summary`, `target_company`, `target_job_title`, `template_id`, `title`, `updated_at`, `user_id`, `volunteering`.
