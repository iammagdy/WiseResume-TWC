# PublicScorecardPage
  ...
  **Type:** reference card
  **Sources:**
  - `src/pages/wisehire/PublicScorecardPage.tsx`
...
- `specs/001-wisehire-hr-platform/spec.md`
  ...
  **What it is:** Public read-only WiseHire scorecard via share token.

  **Route(s):**
  - `  /share/scorecard/:shareToken`

  **Where it lives:** `src/pages/wisehire/PublicScorecardPage.tsx`
