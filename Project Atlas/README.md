...
Welcome to the central knowledge base for The Wise Cloud.

`Project Atlas/` is the only documentation source of truth for WiseResume, WiseHire, architecture, deployment, AI routing, governance, operational state, and agent instructions.
...
- `00-Full-App-Reference/` - full app reference material kept inside the Atlas.
- `01-Currently Implemented/` - verified implementation cards for live or partially-live systems.
- `02-Planned/` - committed plans that are not fully shipped yet.
...
Do not create or rely on documentation folders outside `Project Atlas/`. If useful context is discovered elsewhere, move or summarize it into the Atlas and remove the external document so future readers have one place to trust.
